...
<div style="border-color: #222D32;" class="box">
            <div class="box-header">
              ...
              <h3 id="response" class="box-title">User Activity</h3>
  ...
  <?php
        ...
        $query=mysqli_query($db,"SELECT * FROM tracker LEFT JOIN users ON tracker.uid = users.id LEFT JOIN actionicons ON tracker.iconid = actionicons.id ORDER BY datetime DESC");
        while($row=mysqli_fetch_array($query)){
          ...
          ?>
<tr>
            <td><p class="<?php echo $row['icon']?>"></p></td>
            <td><?php echo $row['firstname']?></td>
            <td><?php echo $row['action']?></td>
            <td><?php echo date("M jS, Y, G:i", strtotime($row['datetime']) + 2 * 3600)?></td>
