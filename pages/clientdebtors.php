...
?>
 ...
 <div class="box">
            <div class="box-header">
              ...
              <h3 id="response" class="box-title"> <?php echo $app->clientname($cid);?> Debtors</h3>
  ...
  <?php
        ...
        $query=mysqli_query($db,"SELECT *, debtors.id AS did FROM debtors LEFT JOIN clients ON debtors.client = clients.id LEFT JOIN statuses ON debtors.status = statuses.id LEFT JOIN users ON debtors.kam = users.id WHERE client = $cid");
...
<tr>
                   ...
                   <td><?php echo 'K '. number_format($row['collected'],2);?></td>
